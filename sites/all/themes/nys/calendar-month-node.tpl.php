...
if($fields['node_data_field_date_field_public_hearing_value']['data'] == 'Session') {
...
<div class="view-item view-item-<?php print $view->name ?>">
  <div class="<?php print $monthviewClass; ?>" id="<?php print $node->date_id ?>">
    ...
    <?php foreach ($fields as $field): if ($field['id'] != 'node-data-field-date-field-public-hearing-value'): ?>
      <div id="<?php print $field['id']; ?>" class="view-field view-data-<?php print $field['id']; if ($field['node_data_field_date_field_public_hearing_value']['data'] == 'Session') { print ' session-day'; }?>">
        <?php if ($field['label']): ?>
